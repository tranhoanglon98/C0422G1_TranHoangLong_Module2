...
public class Triangle {
    ...
    public Triangle(int a, int b, int c) throws IllegalTriangleException {
        if (a < 1) {
            throw new IllegalTriangleException("Cạnh a nhỏ hơn hoặc bằng 0");
        } else if (b < 1) {
            throw new IllegalTriangleException("Cạnh b nhỏ hơn hoặc bằng  0");
        } else if (c < 1) {
            throw new IllegalTriangleException("Cạnh c nhỏ hơn hoặc bằng  0");
